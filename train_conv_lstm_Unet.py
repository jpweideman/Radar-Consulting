...
class UNetConvLSTM(nn.Module):
    def __init__(self, in_ch, out_ch, base_ch=32, lstm_hid=64, seq_len=10):
        super().__init__()
        ...
        # Bottleneck ConvLSTM
        self.lstm = ConvLSTMCell(base_ch*4, lstm_hid)
        # Decoder
        self.up1 = Up(lstm_hid, base_ch*2, base_ch*2)
...
if __name__ == "__main__":
    ...
    pred, truth = predict_validation_set(
        "Data/ZH_radar_dataset.npy", "runs/unet_convlstm_test",
        seq_len_in=10, seq_len_out=1, train_frac=0.6, batch_size=4,
        hidden_dims=[128,128], kernel_size=3, base_ch=32, lstm_hid=64, device="cuda"
    )